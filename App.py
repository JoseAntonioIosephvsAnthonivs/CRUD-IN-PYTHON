...
class Application:
    def __init__(self, master=None):
        ...
        self.titulo["font"] = ("Calibri", "36", "bold")
        self.titulo.pack ()
        ...
        self.lbltelefone = Label(self.container4, text="Celular:", font=self.fonte, width=11)
        ...
        self.txtsenha["width"] = 30
        self.txtsenha["show"] = "*"
        self.txtsenha["font"] = self.fonte
        self.txtsenha.pack(side=LEFT)

        self.bntInsert = Button(self.container8, text="Enviar",font=self.fonte, width=24)
        self.bntInsert["command"] = self.inserirUsuario
        self.bntInsert["bg"] = "pink"
        self.bntInsert.pack (side=LEFT)

        self.bntAlterar = Button(self.container8, text="Limpar Dados", font=self.fonte, width=24)
        self.bntAlterar["command"] = self.alterarUsuario
        self.bntAlterar["bg"] = "pink"
        self.bntAlterar.pack (side=LEFT)

        self.bntExcluir = Button(self.container8, text="Excluir Dados", font=self.fonte, width=24)
        self.bntExcluir["command"] = self.excluirUsuario
        self.bntExcluir["bg"] = "pink"
        self.bntExcluir.pack(side=LEFT)

        self.lblmsg = Label(self.container9, text="")
        self.lblmsg["font"] = ("Verdana", "18", "italic")
        self.lblmsg.pack()
...
#     self.bntInser["command"] = self.inserirUsuario
#     self.bntInsert.pack(side=LEFT)
#
...
#     font=self.fonte, width=12
#     self.bntInser["command"] = self.excluirUsuario
#     self.bntInsert.pack(side=LEFT)
#
#     self.lblmsg = Label(self.container9, text="")
